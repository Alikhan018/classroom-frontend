...
export default function DeniedAccess() {
  return (
    <div>
      <div className="flex justify-center bg-white items-center px-6 py-4 text-sm border-t-2 rounded-b shadow-sm border-red-500">
        <svg
          viewBox="0 0 24 24"
        ...
        <div className="ml-3">
          <div className="font-bold text-left text-black">Access denied</div>
